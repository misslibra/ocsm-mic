...
_base_ = [
    ...
    '../_base_/datasets/uda_human_cycle_gtavHR_to_cityscapesHR_1024x1024.py',
...
name = 'human_cycle_gtaHR2csHR_hrda_s1'
exp = 'basic'
name_dataset = 'human_cycle_gtaHR2cityscapesHR_1024x1024'
