...
_base_ = [
    ...
    '../_base_/datasets/uda_background_gtavHR_to_cityscapesHR_1024x1024.py',
...
name = 'background_gtaHR2csHR_hrda_s1'
exp = 'basic'
name_dataset = 'background_gtaHR2cityscapesHR_1024x1024'
