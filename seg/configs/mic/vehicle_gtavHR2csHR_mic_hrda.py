...
_base_ = [
    ...
    '../_base_/datasets/uda_vehicle_gtavHR_to_cityscapesHR_1024x1024.py',
...
name = 'all_sample_vehicle_gtavHR2csHR_mic_hrda_s2'
exp = 'basic'
name_dataset = 'vehicle_gtavHR2cityscapesHR_1024x1024'
