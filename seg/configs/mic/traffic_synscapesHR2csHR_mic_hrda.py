...
_base_ = [
    ...
    '../_base_/datasets/uda_traffic_synscapesHR_to_cityscapesHR_1024x1024.py',
...
name = 'not_sample_19_traffic_synscapesHR2csHR_mic_hrda_s2'
exp = 'basic'
name_dataset = 'traffic_synscapesHR2cityscapesHR_1024x1024'
