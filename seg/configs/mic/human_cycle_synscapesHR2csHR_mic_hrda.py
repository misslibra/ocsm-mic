...
_base_ = [
    ...
    '../_base_/datasets/uda_human_cycle_synscapesHR_to_cityscapesHR_1024x1024.py',
    # DAFormer Self-Training
    '../_base_/uda/dacs_a999_fd_human_cycle.py',
    # AdamW Optimizer
...
name = 'not_sample_19_human_cycle_synscapesHR2csHR_mic_hrda_s2'
exp = 'basic'
name_dataset = 'human_cycle_synscapesHR2cityscapesHR_1024x1024'
