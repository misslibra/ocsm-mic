...
_base_ = [
    ...
    '../_base_/datasets/uda_synscapesHR_to_cityscapesHR_1024x1024.py',
...
evaluation = dict(interval=50, metric='mIoU') # 4000
# Meta Information for Result Analysis
name = 'synscapesHR2csHR_mic_hrda_s2'
exp = 'basic'
name_dataset = 'synscapesHR2cityscapesHR_1024x1024'
